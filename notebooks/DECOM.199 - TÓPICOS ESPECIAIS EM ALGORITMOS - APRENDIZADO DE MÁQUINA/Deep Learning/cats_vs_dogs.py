...
class Constantes():
    ...
    # endereço de teste dos arquivos de treino, validação e teste
    ARR_STR_DATA_DIR_TESTE = ["data_teste/treino",
                              "data_teste/validacao",
                              "data_teste/teste"]
...
def simple_cnn_model(add_dropout=False):
    ...
    if(add_dropout):
        achatar = layers.Dropout(rate=0.5, seed=Constantes.SEED)(achatar)
    fc_a = dense = layers.Dense(512, activation="relu",name="Dense1")(achatar)
